...
test('vision-segmentation simple python-fire', async () => {
  ...
  await downloadPromise.saveAs(
    './dist-tests/vision-segmentation-simple-python-fire.zip'
  )
})
...
test('vision-segmentation all python-fire', async () => {
  ...
  await downloadPromise.saveAs(
    './dist-tests/vision-segmentation-all-python-fire.zip'
  )
})
...
test('vision-segmentation launch python-fire', async () => {
  ...
  await downloadPromise.saveAs(
    './dist-tests/vision-segmentation-launch-python-fire.zip'
  )
})
...
test('vision-segmentation spawn', async () => {
  ...
  await downloadPromise.saveAs(
    './dist-tests/vision-segmentation-spawn-python-fire.zip'
  )
})
