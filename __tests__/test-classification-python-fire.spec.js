...
test('text-classification simple python-fire', async () => {
  ...
  await downloadPromise.saveAs('./dist-tests/text-classification-simple-python-fire.zip')
})

test('text-classification all python-fire', async () => {
  await page.selectOption('select', 'template-text-classification')
  ...
  await downloadPromise.saveAs('./dist-tests/text-classification-all-python-fire.zip')
})

test('text-classification launch python-fire', async () => {
  await page.selectOption('select', 'template-text-classification')
  ...
  await downloadPromise.saveAs('./dist-tests/text-classification-launch-python-fire.zip')
})

test('text-classification spawn python-fire', async () => {
  await page.selectOption('select', 'template-text-classification')
  ...
  await downloadPromise.saveAs('./dist-tests/text-classification-spawn-python-fire.zip')
})
